...
class _StaffCreationState extends State<StaffCreation> {
  ...
  /// Currently i'm getting these value only using model
  final TextEditingController _firstNameController = TextEditingController();
  final TextEditingController _lastNameController = TextEditingController();
  final TextEditingController _staffRoleController = TextEditingController();

  final List<String> _staffRole = ['Manager', 'Boss', 'Supervisor'];
      ...
      (ImageSource source) async {
        ...
        if (pickedImageProfile != null) {
          if (mounted) {
            ...
            context.read<StaffProfileCubit>().setSelectedImage(imageFile);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<StaffProfileCubit, File?>(
      builder: (context, imageFile) {
      //  final staffValidationCubit = context.read<StaffProfileCubit>();
        return Scaffold(
          ...
          body: SingleChildScrollView(
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    /*   BlocBuilder<StaffProfileImageCubit, File?>(
                  builder: (context, imageFile) {   */
                    ...
                    CustomNewTextFormField(
                      ...
                      starText: '*',
                      hintText: 'Prashant',
                      //    onChanged: (value) => staffValidationCubit.setFirstName(value),
                    ),
                    SizedBox(
                      height: 8.h,
                    ),
                    CustomNewTextFormField(
                      ...
                      starText: '*',
                      hintText: 'Singh',
                      //  onChanged: (value) => staffValidationCubit.setLastName(value),
                    ),
                    SizedBox(
                      height: 8.h,
                    ),
                      ...
                      children: [
                        Expanded(
                          child: CustomDropdown(
                            ...
                            //  onChanged: (value) => staffValidationCubit.setGender(value as Gender),
                          ),
                        ),
                        SizedBox(
                          width: 10.w,
                        ...
                        Expanded(
                          child: CustomTextFormField(
                            ...
                            //      onChanged: (value) => staffValidationCubit.setDob(value),
                    ...
                    CustomDropdown(
                      ...
                      placeholder: 'Role',
                      startText: '*',
                      dropdownController: _staffRoleController,
                      ...
                      onChanged: (value) {
                        setState(() {
                          _selectedRole = value!;
                          _staffRoleController.text = _selectedRole!;
                        });
                      },
                      //  onChanged: (value) => staffValidationCubit.setRole(value!),
                    ),
                    SizedBox(
                      height: 8.h,
                    ),
                    CustomNewTextFormField(
                      ...
                      //   onChanged: (value) => staffValidationCubit.setEmail(value),
                    ),
                    SizedBox(
                      height: 8.h,
                    ),
                    ...
                    CustomPhoneNumberTextField(
                        // onChanged: (value) => staffValidationCubit.setMobileNumber(value!),
                        //controller: ,
                        ),
                            ...
                            ? Column(
                                children: [
                                  ...
                                  CustomNewTextFormField(
                                    ...
                                    //    onChanged: (value) => staffValidationCubit.setStreetAddress(value),
                                  ),
                                  SizedBox(
                                    height: 8.h,
                                  ),
                                  CustomNewTextFormField(
                                    ...
                                    starText: '*',
                                    hintText: '226018',
                                    //     onChanged: (value) => staffValidationCubit.setPinCode(value),
                                  ),
                                  SizedBox(
                                    height: 8.h,
                                  ),
                                  CustomDropdown(
                                    ...
                                    //   onChanged: (value) => staffValidationCubit.setCity(value!),
                                  ),
                                  SizedBox(
                                    height: 8.h,
                                  ),
                                  CustomDropdown(
                                    ...
                                    //     onChanged: (value) => staffValidationCubit.setStateValue(value!),
                                  ),
                                  SizedBox(
                                    height: 8.h,
                                  ),
                                  CustomDropdown(
                                    ...
                                    //    onChanged: (value) => staffValidationCubit.setCountry(value!),
                                  ),
                                ],
                              )
                            ...
                            ? Column(
                                children: [
                                  ...
                                  const CustomNewTextFormField(
                                    ...
                                    /* onChanged: (value) =>
                                        staffValidationCubit.setStateValue(value),*/
                                  ),
                                  SizedBox(
                                    height: 8.h,
                                  ),
                            ...
                            ? Column(
                                children: [
                                  CustomNewTextFormField(
                                    ...
                                    //   onChanged: (value) => staffValidationCubit.setPassword(value),
                                  ),
                    ...
                    CustomButton(
                      onTap: () {
                        if (_firstNameController.text.isEmpty &&
                            ...
                            _staffRoleController.text.isEmpty) {
                          CustomSnackBar.showCustomSnackBar(context,
                              'First Name, Last Name & Staff Role is Required');
                        } else {
                          Navigator.pop(
                              context,
                              Staff(
                                  staffProfile: imageFile.toString(),
                                  firstName:
                                      _firstNameController.text.toString(),
                                  lastName: _lastNameController.text.toString(),
                                  roleType:
                                      _staffRoleController.text.toString()));
